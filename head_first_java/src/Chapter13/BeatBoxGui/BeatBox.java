package Chapter13.BeatBoxGui;
// chapter 13

import Chapter13.JCheck;
        ...
        public void actionPerformed(ActionEvent a)
        {
            ...
            try
            {
                ...
                if (result == JFileChooser.APPROVE_OPTION)
                {
                    ...
                    File b = fileOpen.getSelectedFile();
                    ObjectInputStream is = new ObjectInputStream(new FileInputStream(b));
            ...
            for (int i = 0; i < 256; i++)
            {
                ...
                if (checkboxState[i])
                {
                    System.out.println("Box # " + i + " " + checkboxState[i]);
