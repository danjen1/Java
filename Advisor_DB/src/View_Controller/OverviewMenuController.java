...
public class OverviewMenuController implements Initializable {
    ...
    public void sendCoaching(Advisor advisor){
        ObservableList<Coaching> coach = FXCollections.observableArrayList();
        coach = advisor.getCoach();
        System.out.println(coach);
/*
        detailsCoachingDateCol.setText(String.valueOf(coach.getDate()));
        ...
        if (!(advisor.getCoach() == null)) {
            detailsAdvisorCoachingTableView.setItems(advisor.getCoach());
    ...
    public void onActionOverviewExit(ActionEvent actionEvent) {
