...
abstract class Nav
{
    ...
    public static void menuMaker(String get) throws IOException
    {
        String head = "****************************************************************************************************************************************************************************";
        ...
        String del = "2.Delete";
        String upd = "3.Update";
        String rep = "4.Reports";
        String exi = "5. Exit";
        String adv = "1.Advisor";
        String attend = "2.Attendance";
        String coach = "3.Coaching";
        String goal = "4.Goal";
        String leave = "5.Leave";
        String choice;

        switch(get)
       {
           case "main":
               System.out.println("Main Roster");
               DB.printMain();
               System.out.println("\n\n");
               System.out.println(add + "\t" + del + "\t" + upd + "\t" + rep);
               System.out.println("Make your Selection: (1-4):");
               choice = in.nextLine();
               mainChoice(choice);
           case "add":
               System.out.println("Add Menu");
               System.out.println(head);
               System.out.println(adv + "\t" + attend + "\t" + coach + "\t" + goal + "\t" + leave);
               choice = in.nextLine();
               addChoice(choice);
    ...
    public static void addChoice(String select) throws IOException
    {
        switch(select)
        {
            case "1":
    ...
    public static void mainChoice(String select) throws IOException
    {
        switch(select)
        {
            case "1":
