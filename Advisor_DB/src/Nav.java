...
public class Nav
{
    public static void main(String[] args) throws IOException, ClassNotFoundException
    {
      ...
      /*  new Attendance("Madison Jenkins", "8/16/18", "Full Day", 8, "Test Attendance 2");
        ...
        new Attendance("Madison Jenkins", "8/16/18", "iLOA", 8, "Test Attendance 2");
        new Attendance("Madison Jenkins", "8/13/18", "iLOA", 8, "Test Attendance 2");
        new Attendance("Madison Jenkins", "7/16/18", "iLOA", 8, "Test Attendance 2");
        new Attendance("Madison Jenkins", "7/13/18", "iLOA", 8, "Test Attendance 2");
        new Attendance("Madison Jenkins", "6/16/18", "iLOA", 8, "Test Attendance 2");
        new Attendance("Madison Jenkins", "6/13/18", "iLOA", 8, "Test Attendance 2");
        new Attendance("Madison Jenkins", "8/16/18", "iLOA", 8, "Test Attendance 2");
        new Attendance("Madison Jenkins", "8/13/18", "iLOA", 8, "Test Attendance 2");
...
*/
       // DB.printAdv("Madison Jenkins");
        //DB.printAdv("Daniel Jenkins");
      // DB.printAdvAll();
